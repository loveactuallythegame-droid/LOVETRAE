...
export default function SixSecondKiss({ navigation }: any) {
    useEffect(() => {
        speakMarcie("You peaked early. Again. Pace yourselves, loves.");
    }, []);
        ...
        <LinearGradient colors={['#2A0040', '#000000']} style={styles.container}>
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.header}>
                    ...
                    <Text variant="header" style={styles.title}>The 6-Second Kiss Timer</Text>
                </View>

                <GlassCard style={styles.card}>
                    <Text variant="instructions" style={{ marginBottom: 10 }}>Type: Dual thumb-hold</Text>
                    <Text variant="body">Mechanics: Both hold thumb → bar fills at combined pressure. Sustain 6s.</Text>
                </GlassCard>
                ...
                <GlassCard style={styles.card}>
                    ...
                    <Text variant="body">
                        ✅ 6s sustained = +25{'\n'}
                        ✅ Pressure curve match = +10
                    </Text>
                </GlassCard>

                <View style={styles.actionArea}>
                    <SquishyButton onPress={() => alert('Ready? Kiss!')} style={styles.playBtn}>
