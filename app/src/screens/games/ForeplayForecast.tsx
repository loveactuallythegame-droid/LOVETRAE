        ...
        <LinearGradient colors={['#2A0040', '#000000']} style={styles.container}>
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.header}>
                    ...
                    <Text variant="header" style={styles.title}>Foreplay Forecast</Text>
                </View>

                <GlassCard style={styles.card}>
                    <Text variant="instructions" style={{ marginBottom: 10 }}>Type: Live mood slider</Text>
                    <Text variant="body">Mechanics: A sets arousal bar (0–100). B performs non-sexual acts (compliment, neck rub) to raise it.</Text>
                </GlassCard>
                ...
                <View style={styles.actionArea}>
                    <SquishyButton onPress={() => alert('Opening Slider...')} style={styles.playBtn}>
                        <Text variant="header">Start Forecast</Text>
                    </SquishyButton>
                </View>
            </ScrollView>
        </LinearGradient>
