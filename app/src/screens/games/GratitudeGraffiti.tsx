...
export default function GratitudeGraffiti({ navigation }: any) {
    useEffect(() => {
        speakMarcie("‘You’re the guac to my toast’? 10/10. Snackable and profound.");
    }, []);
        ...
        <LinearGradient colors={['#2A0040', '#000000']} style={styles.container}>
            <ScrollView contentContainerStyle={styles.content}>
                <View style={styles.header}>
                    ...
                    <Text variant="header" style={styles.title}>Gratitude Graffiti</Text>
                </View>

                <GlassCard style={styles.card}>
                    <Text variant="instructions" style={{ marginBottom: 10 }}>Type: Shared mural</Text>
                    <Text variant="body">Mechanics: 60 sec to write/draw appreciation—only metaphors.</Text>
                </GlassCard>
                ...
                <GlassCard style={styles.card}>
                    ...
                    <Text variant="body">
                        ✅ Metaphor = +10{'\n'}
                        ✅ Partner ❤️ = +10{'\n'}
                        ✅ AI detects novelty = +5
                    </Text>
                </GlassCard>

                <View style={styles.actionArea}>
                    <SquishyButton onPress={() => alert('Loading Mural...')} style={styles.playBtn}>
                        <Text variant="header">Start Drawing</Text>
                    </SquishyButton>
                </View>
            </ScrollView>
        </LinearGradient>
